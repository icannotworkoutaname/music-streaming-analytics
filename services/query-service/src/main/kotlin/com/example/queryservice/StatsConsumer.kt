...
import com.example.queryservice.model.SongHourlyCount
...
class StatsConsumer(private val redisTemplate: StringRedisTemplate) {
    ...
    @KafkaListener(
        ...
        properties = ["spring.json.value.default.type=com.example.queryservice.model.SongCompletionStats"]
    )
    ...
    @KafkaListener(
        ...
        properties = ["spring.json.value.default.type=com.example.queryservice.model.SongHourlyCount"]
    )
